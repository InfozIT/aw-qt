...
class TrayIcon(QSystemTrayIcon):
    ...
    def __init__(
        ...
        self.setToolTip("InfozIT Tracker" + (" (testing)" if testing else ""))
    ...
    def _build_rootmenu(self) -> None:
        ...
        if exitIcon.availableSizes():
            menu.addAction(exitIcon, "Quit InfozIT Tracker", lambda: exit(self.manager))
        else:
            menu.addAction("Quit InfozIT Tracker", lambda: exit(self.manager))
    ...
    if not QSystemTrayIcon.isSystemTrayAvailable():
        ...
        for i in range(10):
            ...
            QMessageBox.critical(
                widget,
                "Systray",
                "I couldn't detect any system tray on this system. Either get one or run the InfozIT Tracker modules from the console.",
            )
            sys.exit(1)
